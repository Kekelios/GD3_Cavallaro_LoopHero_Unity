...
public class MiniGamePlayerController : MonoBehaviour
{
    ...
    [Header("Saut")]
    [Tooltip("Active le saut pour ce mini-jeu. Désactivé dans MiniGameSceneName.")]
    ...
    /// <summary>Appelé automatiquement par le New Input System (action "Jump").</summary>
    ...
    /// <summary>Applique la gravité et le saut.</summary>
    ...
    /// <summary>D�clenche l'animation Victory.</summary>
